...
export const PROJECTS: ProjectItem[] = [
  {
    id: 'gsy-hardware',
    title: 'GSY Hardware',
    subtitle: 'Premium Hardware Supplier & E-Commerce Platform',
    year: '2026',
    featured: true,
    type: 'Personal Project',
    previewType: 'web',
    description: 'A comprehensive, end-to-end online store engineered for a commercial hardware distributor. Powers digital procurement of electrical wires, circuit breakers, heavy-duty tools, and construction essentials with fast nationwide delivery and wholesale PDC terms.',
    highlights: [
      ...
      'Designed administrative management dashboard with live inventory stock alerts, live store visitor counter, and sales analytics.',
    ],
